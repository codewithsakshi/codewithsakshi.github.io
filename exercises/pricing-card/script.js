...
const professionalPlanPriceElement = document.querySelector(
...
checkboxElement.addEventListener('click', function () {
  ...
  basicPlanPriceElement.textContent =
    basicPlanText === '$199.99' ? '$19.99' : '$199.99';
  professionalPlanPriceElement.textContent =
    professionalPlanText === '$249.99' ? '$24.99' : '$249.99';
  masterPlanPriceElement.textContent =
    masterPlanPriceText === '$399.99' ? '$39.99' : '$399.99';
});
